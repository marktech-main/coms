													...
													<div class="form-group">
															...
															<div class="col-lg-9 col-sm-9">
																<select name="come_from" class="form-control">
																	<option value="" selected hidden disabled>Choose Come From</option>
...
$(document).ready(function() {
	...
	$(document).on('keyup', 'input[type=number] + input', function(data){
		...
		?>
				console.log('enter 1');
				if( $('[name="transaction_type_id"]').val() == 'G8uCVTKT8FrBbR6eQ3IEq9Dd%2B%2BKJpyKEOyTVgSG5o0g%3D')         // use this if you are using class to check
				{
					console.log('enter 2');

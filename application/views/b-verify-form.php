                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="clearfix"></div>
												...
												<?php if($request_transaction->transaction_type_name != 'RESET-PASSWORD'){?>
                        ...
                        <?php
                          if($request_transaction->transaction_type_name != 'TRANSFER' && $request_transaction->transaction_type_name != 'RESET-PASSWORD'){
                        ?>
...
socket.on('conversation_private_post', function(data) {
	...
	socket.on('update_pending_transaction', function(message){
		console.log('extends socket on update_pending_transaction 1');
		console.log(message);
...
// extends socket event for update_request_transaction to update page contents
 socket.on('update_request_transaction', function(message){
	 console.log('extends socket on update_request_transaction 1');
	 console.log(message);
